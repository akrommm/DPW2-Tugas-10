                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        <label>Berat:</label>
                                        <p>{{number_format ($produk->berat)}} kg</p>
            ...
            <div class="row">
                <div class="col-6">
                    <figure class="product-media">
                        <a href="{{ url('product') }}">
                            <img src="{{url("public", $produk->foto)}}" alt="Product image">
                        </a>
                ...
                <ul class="mobile-menu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('shop') }}">Shop Grid 3 Columns</a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="elements-product-{{ url('shop') }}">Product Category</a></li>
